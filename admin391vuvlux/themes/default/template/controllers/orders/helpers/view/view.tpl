			...
			geocoder.geocode({
				...
				if (status === google.maps.GeocoderStatus.OK)
				{
					...
					var delivery_marker = new google.maps.Marker({
						...
						url: 'http://maps.google.com?key=AIzaSyB-Y6d5mbYbMdYe57g_l9qVmNcdnfVQJ_c&q={$addresses.delivery->address1|urlencode},{$addresses.delivery->postcode|urlencode},{$addresses.delivery->city|urlencode}{if isset($addresses.deliveryState->name) && $addresses.delivery->id_state},{$addresses.deliveryState->name|urlencode}{/if},{$addresses.delivery->country|urlencode}'
					});
