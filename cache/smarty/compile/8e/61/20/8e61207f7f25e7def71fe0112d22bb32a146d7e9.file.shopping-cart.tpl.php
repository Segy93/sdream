<?php /* Smarty version Smarty-3.1.19, created on 2022-09-16 10:21:47
         compiled from "/home/sdream/public_html/sdream.rs/themes/SDreamShopTheme/shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9921982266324321b8d28d7-68362279%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8e61207f7f25e7def71fe0112d22bb32a146d7e9' => 
    array (
      0 => '/home/sdream/public_html/sdream.rs/themes/SDreamShopTheme/shopping-cart.tpl',
      1 => 1574342045,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9921982266324321b8d28d7-68362279',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6324321bcbea12_92758823',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6324321bcbea12_92758823')) {function content_6324321bcbea12_92758823($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include '/home/sdream/public_html/sdream.rs/tools/smarty/plugins/modifier.regex_replace.php';
?>
...
">
 ...
 <?php $_smarty_tpl->tpl_vars['producter'] = new Smarty_variable(array(), null, 0);?>
...
<?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['product']->value['category'];?>
<?php $_tmp4=ob_get_clean();?><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['product']->value['id_product'];?>
<?php $_tmp5=ob_get_clean();?><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['product']->value['id_product_attribute'];?>
<?php $_tmp6=ob_get_clean();?><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['product']->value['attributes'];?>
<?php $_tmp7=ob_get_clean();?><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['product']->value['price'];?>
<?php $_tmp8=ob_get_clean();?><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['cart']->value->id;?>
<?php $_tmp9=ob_get_clean();?><?php ob_start();?><?php echo Context::getContext()->customer->id;?>
<?php $_tmp10=ob_get_clean();?><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['product']->value['quantity'];?>
<?php $_tmp11=ob_get_clean();?><?php $_smarty_tpl->createLocalArrayVariable('producter', null, 0);
$_smarty_tpl->tpl_vars['producter']->value[] = array('kategorijaProizvoda'=>$_tmp4,'idProizvoda'=>$_tmp5,'idAtributaProizvoda'=>$_tmp6,'atributProizvoda'=>$_tmp7,'cenaProizvoda'=>$_tmp8,'cartId'=>$_tmp9,'userId'=>$_tmp10,'kolicina'=>$_tmp11);?>
...
<?php } ?>
 ...
 <?php echo Cart::brisacica($_smarty_tpl->tpl_vars['producter']->value);?>

 <?php echo Cart::kukurnica($_smarty_tpl->tpl_vars['producter']->value);?>


<script>
    $( ".cart_discount_name" ).each(function(  ) {
  if( $( this ).text() === 'Popust 5% na dušeke u kombinaciji sa krevetima'){
console.log(  $( this ).text() );
$('.buttoner').text('Popust je aktiviran').css({"pointer-events":"none"});
}
});
...
<?php $_tmp17=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&amp;id_product=".$_tmp16."&amp;ipa=".$_tmp17."&amp;id_customization=".((string)$_smarty_tpl->tpl_vars['id_customization']->value)."&amp;id_address_delivery=".((string)$_smarty_tpl->tpl_vars['product']->value['id_address_delivery'])."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
"
											rel="nofollow"
