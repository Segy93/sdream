...
class CustomerThreadCore extends ObjectModel
{
    ...
    public static $definition = array(
        ...
        'fields' => array(
            ...
            'extrafield3' =>  array('type' => self::TYPE_STRING, 'validate' => 'isGenericName'),
            'extrafield4' =>  array('type' => self::TYPE_STRING, 'validate' => 'isGenericName'),
            'extrafield5' =>  array('type' => self::TYPE_STRING, 'validate' => 'isGenericName'),
        ),
    );
