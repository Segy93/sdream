            ...
            if (!($from = trim(Tools::getValue('from'))) || !Validate::isEmail($from)) {
                ...
                if ($contact->customer_service) {
                    if ((int)$id_customer_thread) {
                        ...
                        $ct->extrafield2 = Tools::getValue('extrafield2');
                         $ct->extrafield3 = Tools::getValue('extrafield3');
                          $ct->extrafield4 = Tools::getValue('extrafield4');
                           $ct->extrafield5 = Tools::getValue('extrafield5');
                        $ct->update();
                    } else {
                ...
                if (!count($this->errors)) {
                    $var_list = array(
                                    ...
                                    '{extrafield3}' =>  (isset($ct) && $ct->extrafield3) ? $ct->extrafield3 : '',
                                    '{extrafield4}' =>  (isset($ct) && $ct->extrafield4) ? $ct->extrafield4 : '',
                                    '{extrafield5}' =>  (isset($ct) && $ct->extrafield5) ? $ct->extrafield5 : ''
                                );
    ...
    */
    public function initContent()
    {
        ...
        $this->context->smarty->assign(array(
            ...
            'extrafield' =>  (isset($ct) && $ct->extrafield) ? $ct->extrafield : '',
            'extrafield2' =>  (isset($ct) && $ct->extrafield) ? $ct->extrafield : '',
            'extrafield3' =>  (isset($ct) && $ct->extrafield) ? $ct->extrafield : '',
            'extrafield4' =>  (isset($ct) && $ct->extrafield) ? $ct->extrafield : '',
            'extrafield5' =>  (isset($ct) && $ct->extrafield) ? $ct->extrafield : '',
