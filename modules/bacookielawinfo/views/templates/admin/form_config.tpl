...
<div class="bootstrap ba_error">
	<div class="module_error alert alert-danger">
		{l s='You are use ' mod='bacookielawinfo'}
		<strong>{l s='Demo Mode' mod='bacookielawinfo'}</strong>
		{l s=', so some buttons, functions will be disabled because of security. ' mod='bacookielawinfo'}<br />
		{l s='You can use them in Live mode after you puchase our module. ' mod='bacookielawinfo'}<br />
		{l s='Thanks !' mod='bacookielawinfo'}
	</div>
</div>
{/if}
<form id="ba_eu_cookie_law" action="" method="POST">
	<div id="custom_colors_section">
		<div><h2>{l s='BA Cookie Law Info' mod='bacookielawinfo'}</h3></div>
		
		<div class="form-horizontal colors" style="position:relative;">
			<fieldset>
				<div><h3 style="margin: 0 0 10px 0;">{l s='Settings' mod='bacookielawinfo'}</h3></div>
				<div class="control-group">
					<label class="control-label">{l s='Cookie Bar enable/disable' mod='bacookielawinfo'}: </label>
					<div class="controls">
				...
				<div class="control-group">
					<div class="controls">
						<label class="control-label">{l s='Cookie Bar display in' mod='bacookielawinfo'}: </label>
						<select name="BAEU_CookieBarShowIn" style="width:100px;">
							<option value="1" {if $BAEU_CookieBarShowIn=="1"}selected{/if}>{l s='Header' mod='bacookielawinfo'}</option>
							<option value="2" {if $BAEU_CookieBarShowIn=="2"}selected{/if}>{l s='Footer' mod='bacookielawinfo'}</option>
							<option value="3" {if $BAEU_CookieBarShowIn=="3"}selected{/if}>{l s='Popup' mod='bacookielawinfo'}</option>
						</select>
					</div>
				</div>
				<div class="control-group">
					<div class="controls">
						<label class="control-label">{l s='Waiting loading' mod='bacookielawinfo'}: </label>
						<select name="BAEU_OnLoad" style="width:100px;">
							<option value="1" {if $BAEU_OnLoad=="1"}selected{/if}>{l s='Animate' mod='bacookielawinfo'}</option>
							<option value="2" {if $BAEU_OnLoad=="2"}selected{/if}>{l s='Sticky' mod='bacookielawinfo'}</option>
						</select>
					</div>
				</div>
				...
				<div class="control-group">
					<div class="controls">
						<label class="control-label">{l s='Waiting  hide' mod='bacookielawinfo'}: </label>
						<select name="BAEU_OnHide" style="width:100px;">
							<option value="1" {if $BAEU_OnHide=="1"}selected{/if}>{l s='Animate' mod='bacookielawinfo'}</option>
							<option value="2" {if $BAEU_OnHide=="2"}selected{/if}>{l s='Disappear' mod='bacookielawinfo'}</option>
						</select>
					</div>
				</div>
				...
				<div class="control-group">
					<div class="controls">
						<label class="control-label">{l s='Auto-hide cookie bar when expired?' mod='bacookielawinfo'} </label>
						<div class="controls">
							<label class="checkbox">
				...
				<div class="control-group ">
					<label class="control-label">{l s='Milliseconds until expiration' mod='bacookielawinfo'}</label>
					<div class="controls">
					...
					<label class="help-block">{l s='Specify milliseconds (not seconds) e.g. 3000 = 3 seconds' mod='bacookielawinfo'}</label>
				</div>
				
				<div class="control-group">
					<label class="control-label">{l s='Auto-hide cookie bar when the user scrolls?' mod='bacookielawinfo'}</label>
					<div class="controls">
						<label class="checkbox">
				...
				<!--<div class="control-group">
					<label class="control-label">{l s='Reload after "scroll accept" event?' mod='bacookielawinfo'}</label>
					<div class="controls">
						<label class="checkbox">
				...
				<div class="control-group" style="width:100%;">
					<label class="control-label">{l s='Customise CSS' mod='bacookielawinfo'}</label>
				...
				<div class="wrap-header2 col-sm-12"><h3 style="margin: 0 0 10px 0;">{l s='MESSAGE SETTINGS' mod='bacookielawinfo'}</h3></div>
				
				<div class="col-sm-12" style="margin:5px 0;">
					<label class="control-label">{l s='Message' mod='bacookielawinfo'}: </label>
					<div class="controls col-sm-7">
				...
				<div class="control-group">
					<label class="control-label">{l s='Cookie Bar Color' mod='bacookielawinfo'}</label>
					<div class="controls">
						<input name="BAEU_CookieBarColor" class="color" value="{$BAEU_CookieBarColor|escape:'htmlall':'UTF-8'}">
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">{l s='Text Color' mod='bacookielawinfo'}</label>
					<div class="controls">
						<input name="BAEU_TextColor" class="color" value="{$BAEU_TextColor|escape:'htmlall':'UTF-8'}">
					</div>
				</div>
				<div class="control-group first-item">
					<label class="control-label">{l s='Enable/Disnable Border?' mod='bacookielawinfo'}</label>
					<div class="controls">
						<label class="checkbox">
				...
				<div class="control-group">
					<label class="control-label">{l s='Border Color' mod='bacookielawinfo'}</label>
					<div class="controls">
						<input name="BAEU_BoderColor" class="color" value="{$BAEU_BoderColor|escape:'htmlall':'UTF-8'}">
					</div>
				</div>
				
				<div class="wrap-header2 col-sm-12"><h3 style="margin: 0 0 10px 0;">{l s='ACCEPT BUTTON SETTINGS' mod='bacookielawinfo'}</h3></div>
				
				{*<div class="control-group" style="width:100%;">{l s='This button/link can be customised to either simply close the cookie bar, or follow a link. You can also customise the colours and styles, and show it as a link or a button.' mod='bacookielawinfo'}</div>*}
				
				<div class="control-group" style="width:100%;">
					<label class="control-label">{l s='Link text' mod='bacookielawinfo'}</label>
				...
				<div class="control-group">
					<div class="controls">
						<label class="control-label">{l s='Action' mod='bacookielawinfo'}: </label>
						<select name="BAEU_leftAction" style="width:100px;">
							<option value="1" {if $BAEU_leftAction=="1"}selected{/if}>{l s='Close Alert' mod='bacookielawinfo'}</option>
							<option value="2" {if $BAEU_leftAction=="2"}selected{/if}>{l s='Open URL' mod='bacookielawinfo'}</option>
						</select>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">{l s='URL link' mod='bacookielawinfo'}</label>
					<div class="controls">
						<input type="text" name="BAEU_leftLinkURL" class="form-control" value="{$BAEU_leftLinkURL|escape:'htmlall':'UTF-8'}" style="width:100px;">
					</div>
					<label class="help-block">{l s='Button only linking to the URL if Action  = Display URL' mod='bacookielawinfo'}</label>
				</div>
				<div class="control-group">
					<div class="controls">
						<label class="control-label">{l s='Open URL in new window?' mod='bacookielawinfo'} </label>
						<div class="controls">
							<label class="checkbox">
				...
				<div class="control-group">
					<label class="control-label">{l s='Link Color' mod='bacookielawinfo'}</label>
					<div class="controls">
				...
				<div class="control-group" style="clear: both;">
					<div class="controls">
						<label class="control-label">{l s='Show as button?' mod='bacookielawinfo'} </label>
						<div class="controls">
							<label class="checkbox">
				...
				<div class="control-group">
					<label class="control-label">{l s='Button color' mod='bacookielawinfo'}</label>
					<div class="controls">
						<input name="BAEU_leftButtonColor" class="color" value="{$BAEU_leftButtonColor|escape:'htmlall':'UTF-8'}">
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">{l s='Hover Text color' mod='bacookielawinfo'}</label>
					<div class="controls">
						<input name="BAEU_leftHoverButtonColor" class="color" value="{$BAEU_leftHoverButtonColor|escape:'htmlall':'UTF-8'}">
					</div>
				</div>
				
				<div class="wrap-header2 col-sm-12"><h3 style="margin: 0 0 10px 0;">{l s='READ MORE BUTTON SETTINGS' mod='bacookielawinfo'}</h3></div>
				<div class="control-group" style="width:100%;">{l s='This button or link can be used to provide a link out to your Privacy & Cookie Policy. You can customise it any way you like' mod='bacookielawinfo'}</div>
				<div class="control-group" style="width:100%;">
					<label class="control-label">{l s='Link text' mod='bacookielawinfo'}</label>
					<div class="controls col-sm-5">
						{foreach from=$arr_language key=key_lang item=language}
	...
	<div class="panel-footer">
			...
			<button type="submit" value="1" id="module_form_submit_btn" name="submitbaCancel" class="btn btn-default pull-left">
				<i class="process-icon-cancel"></i> {l s='Cancel' mod='bacookielawinfo'}
			</button>
			<button type="submit" value="1" id="module_form_submit_btn" name="submitba" class="btn btn-default pull-right">
				<i class="process-icon-save"></i> {l s='Save' mod='bacookielawinfo'}
			</button>
			<button type="submit" name="submitBaAndStay" class="btn btn-default pull-right"><i class="process-icon-save"></i> {l s='Save and stay' mod='bacookielawinfo'}</button>
