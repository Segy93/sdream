...
$( "#footer" ).append('<div class="row"><section class="footer-block col-xs-12 col-sm-2" id="open1"><span class="open1" onclick="open1()"><i id="iO1" class="fa fa-sort-desc" aria-hidden="true"></i></span><h4>Informacije </h4><ul class="toggle-footer" style=""><li><a href="https://www.sdream.rs/sr/info/o-nama/" title="O nama" style=" position: relative; top: 1px;">O nama</a></li><li><a id="maloZ1 " href="https://sdream.rs/sr/info/maloprodaje/" title="Maloprodaje" style=" position: relative; top: 1px;">Maloprodaje</a></li><li><a id="sertifikatiZen" href="https://sdream.rs/sr/info/sertifikati/" title="Sertifikati" style=" position: relative; top: 1px;">Sertifikati</a></li><li><a id="partneriZen" href="https://sdream.rs/sr/info/partneri/" title="Partneri" style=" position: relative; top: 1px;">Partneri</a></li><li><a id="modeliSaradnjeZen" href="https://sdream.rs/sr/info/modeli-saradnje/" title="Modeli saradnje" style=" position: relative; top: 1px;">Modeli saradnje</a></li></ul></section><section class="footer-block col-xs-12 col-sm-2" id="open2"><span class="open2" onclick="open2()"><i id="iO2" class="fa fa-sort-desc" aria-hidden="true"></i></span><h4> Pomoć pri kupovini </h4><ul class="toggle-footer" style=""><li><a id="kakoOdabratiZen1" href="https://sdream.rs/sr/info/kako-odabrati-dusek/" title="Kako odabrati dušek" style=" position: relative; top: 1px;">Kako odabrati dušek</a></li><li><a id="kakoKupitiZen1" href="https://sdream.rs/sr/info/kako-kupiti/" title="Kako kupiti" style=" position: relative; top: 1px;">Kako kupiti</a></li><li style="position: relative;top: 1px;"><a href="https://www.sdream.rs/sr/info/nacin-placanja/" title="Način plaćanja">Način plaćanja</a></li><li style="position: relative;top: 0px;"><a href="https://www.sdream.rs/sr/info/kako-dodati-novu-adresu/" title="Kako dodati novu adresu">Kako dodati novu adresu</a></li><li style="position: relative;top: 1px;"><a span="" id="faqZen1" href="https://sdream.rs/sr/info/najcesca-pitanja/" title="Najčešća pitanja">Najčešća pitanja</a></li><li style="position: relative;top: 0px;"><a href="https://www.sdream.rs/sr/info/isporuka/" title="Isporuka">Isporuka</a></li><li class="item"></li></ul></section><section id="open3" class="footer-block col-xs-12 col-sm-2"><span class="open3" onclick="open3()"><i id="iO3" class="fa fa-sort-desc" aria-hidden="true"></i></span><h4> Moj nalog </h4><div class="block_content toggle-footer" style=""><ul class="toggle-footer" style=""><li><a id="orderHistoryZen" href="https://www.sdream.rs/sr/moje-porudzbine" title="Moje porudžbine" rel="nofollow">Moje porudžbine </a></li><li><a id="identityZen" href="https://www.sdream.rs/sr/moji-licni-podaci" title="Moji lični podaci" rel="nofollow">Moji lični podaci </a></li><li style="position: relative;top: 0px;"><a href="https://www.sdream.rs/sr/info/reklamacije/" title="Moje reklamacije">Moje reklamacije</a></li><li><a href="https://www.sdream.rs/sr/poklon-vaucer" title="Moji vaučeri" rel="nofollow" id="discountZen">Moji vaučeri </a></li></ul></div></section><section id="open4" class="block_contact_infos footer-block col-xs-12 col-sm-4"><span class="open4" onclick="open4()"><i id="iO4" class="fa fa-sort-desc" aria-hidden="true"></i></span> <h4> Informacije o pravnom licu </h4><ul class="toggle-footer" style=""><li><i class="icon-map-marker ikoneiceFooterZ"> </i>Srbija, Čačak 32212, <br>ul. Radonje Golubovića Goluba br. 9</li><li><i class="icon-phone ikoneiceFooterZ"> </i>Telefon: <span><a href="tel:+381 32 53 77 050" style="">+381 32 53 77 050</a></span> </li><li><i class="icon-envelope-alt ikoneiceFooterZ"> </i>Email: <span><a href="mailto:office@sdream.rs?subject=email poruka sa www.sdream.rs || poruka poslata preko sajt footera">office@sdream.rs </a></span></li></ul></section><section id="open5" class="footer-block col-xs-12 col-sm-2"><span class="open5" onclick="open5()"><i id="iO44" class="fa fa-sort-desc" aria-hidden="true"></i></span> <h4>Podaci o pravnom licu </h4><ul class="toggle-footer" style=""><li> <a href="https://www.vapeks.rs" target = "_blank"><img src="https://www.sdream.rs/img/vapex-logo.png" alt="Vapex logo" height="40"></a></li><li><a href="https://www.vapeks.rs" target = "_blank">www.vapeks.rs</a></li><li>PIB: 103209922</li><li>MB: 17533827 </li><li>Šifra de. 2016</li></ul></section></div>');
$('.footer-container').append('<div style=" border-top: 1px solid rgba(6,4,3,0.1); border-bottom: 1px solid rgba(6,4,3,0.1);"><div class="footer-cards-payment" style="background: radial-gradient(rgba(0,0,0,.1), transparent);padding: 8px 0px;margin: 0 auto;display: table;"><div><span class="footer-card-logo credit-card-maestro" style=""></span></div><div><span class="footer-card-logo credit-card-master" style=""></span></div><div data-tooltip-position="top" data-tooltip="Saznajte više o MasterCard asociaciji"><a href="https://www.mastercard.us/en-us/consumers/payment-technologies/securecode.html" target="_blank"><span style="" class="footer-card-logo masterCardSecure"></span></a></div><div><span class="footer-card-logo credit-card-visa" style=""></span></div><div><span class="footer-card-logo credit-card-visa-electron" style=""></span></div><div data-tooltip-position="top" data-tooltip="Saznajte više o Visa asociaciji"><a href="https://usa.visa.com/pay-with-visa/featured-technologies/verified-by-visa.html" target="_blank"><span class="footer-card-logo verivied-by-visa" style=""></span></a></div><div><span class="footer-card-logo credit-card-dina-card" style=""></span></div><div data-tooltip-position="top" data-tooltip="Posetite sajt Komercijalne banke"><a href="https://www.kombank.com/sr" target="_blank"><span class="footer-card-logo komercijalna-banka" style=""></span></a></div></div></div><center style="float: none;"><div style="display:none" id="vzmanKa">guzanka</div><div style="display:none" id="vrvi2">guzanka</div><div class="bottomFooterZ" style="padding:16px;background: radial-gradient(rgba(0,0,0,.1), transparent);"><address style="color: #222222;margin: 0;"><a href="https://www.sdream.rs/sr/info/uslovi-koriscenja/" style=" color: #222; font-weight: 900;" title="Uslovi korišćenja">Uslovi korišćenja</a> | <a href="https://www.sdream.rs/sr/info/politika-privatnosti/" style=" color: #222; font-weight: 900;" title="Politika privatnosti">Politika privatnosti</a> | <a href="https://sdream.rs/sr/mapa-sajta" style=" color: #222; font-weight: 900;" title="Mapa sajta">Mapa sajta</a> | <a href="https://sdream.rs/sr/info/web-aplikacija/" style=" color: #222; font-weight: 900;" title="S Dream web aplikacija">S Dream web aplikacija</a> | © 2013 - 2019 <b>S Dream</b> Sva prava zadržana.<p style=" margin: 0; font-size: 13px; letter-spacing: -0.1px;">Cene na sajtu su iskazane u dinarima sa uračunatim porezom, a plaćanje se vrši isključivo u dinarima.</p></address></div></center>');
$('#kinoZen').append('<ul class="topNavigationMenuZ"><li><span style="cursor:pointer;" id="kakoKupitiZen2" class="listinaSlova" onclick="pageCheclkakoKupiti()">Kako kupiti</span></li><li><span style="cursor:pointer;" id="kakoOdabratiZen2" class="listinaSlova" onclick="pageCheclkakoOdabrati()">Kako odabrati dušek</span></li><li><a href="https://www.sdream.rs/sr/info/nacin-placanja/" style="cursor:pointer;" class="listinaSlova">Način plaćanja</a></li><li><span id="faqZen2" onclick="pageCheckFAQ()" style="cursor:pointer;" class="listinaSlova">Najčešća pitanja</span></li></ul>');	
...
document.title = 'O nama - S Dream Shop';	
					...
					$( ".shopping_cart" ).click(function() {
						window.location.href=  'https://www.sdream.rs/sr/order'
						});				
	   	...
	   	if (xzzy.indexOf("/info/reklamacije/") >= 0) {
...
$('#htmlcontent_top ul li#z0zz0 a').attr('href','https://www.sdream.rs/sr/kako-odabrati-dusek/');
...
$('#htmlcontent_home ul li#z0zz0 a').attr('href','https://www.sdream.rs/sr/akcije');			
$('#htmlcontent_home ul li#z1zz1 a').attr('href','https://www.sdream.rs/sr/akcije');
$('#htmlcontent_home ul li#z2zz2 a').attr('href','https://www.sdream.rs/sr/mladenci-special/');			
$('#htmlcontent_home ul li#z3zz3 a').attr('href','https://www.sdream.rs/sr/akcije');			
$('#htmlcontent_home ul li#z4zz4 a').attr('href','https://www.sdream.rs/sr/akcije');			


$( "#homeslider li" ).each(function() {
	var zamba= $( this ).find('a').attr('title');
	if(zamba==='Do 30% popusta za mladence'){
  $( this ).find('a').attr('href','https://www.sdream.rs/sr/mladenci-special/');
	}
	if(zamba==='Do 25% popusta na dušeke'){
  $( this ).find('a').attr('href','https://www.sdream.rs/sr/akcije');
	}
});	
...
el.innerHTML = '<div class=reggDiv id=reggDiv><i aria-hidden=true class="fa fa-gift fazli"id=c1></i><div class=divCenterZ2 id=c2><span class=textZ2>Registrujte se na naš web sajt i preuzmite poklon vaučer od 1.000 RSD, koji možete iskoristiti prilikom kupovine za iznose veće od 10.000 RSD.  Kako iskoristiti poklon vaučer možete pročitati <span onclick="pageCheclkakoKupiti()" style="cursor:pointer;">OVDE...</span></span></div><a class=buttonZ2 href="https://www.sdream.rs/sr/login?back=my-account"id=c3>Klikni za registraciju</a></div>';
...
el2.innerHTML = '<div class="borderZ row" style="margin:8px; padding-top:8pxpx;"> <div id="cZZ1" class="col-lg-3"> <div class="divLeft"> <i style="" class="faZ fa fa-id-card-o" aria-hidden="true"> </i> </div><div class="divright"> <h4> Odaberite način plaćanja koji Vam najviše odgovara </h4> <h6> Uskoro dostupno i online plaćanje kreditnom karticom </h6> </div></div><div id="cZZ2" class="col-lg-3"> <div class="divLeft"> <i style="" class="faZ fa fa-thumbs-o-up" aria-hidden="true"> </i> </div><div class="divright"> <h4> Raskid ugovora na daljinu </h4> <h6> Potrošač ima pravo da odustane od ugovora zaključenog na daljinu, odnosno izvan poslovnih prostorija u roku od 14 dana, bez navođenja razloga. </h6> </div></div><div id="cZZ3" class="col-lg-3"> <div class="divLeft"> <i style="" class="faZ2 fa fa-phone " aria-hidden="true"> </i> <i style="font-size:60px!important;position:relative!important; bottom:2px;" class="faZ fa fa-circle-thin" aria-hidden="true"> </i> </div><div class="divright"> <h4> Telefonska podrška </h4> <h6> Potrebna Vam je pomoć ili imate pitanje u vezi poručivanja. Naši operateri će Vam pomoći korak po korak, pozovite <a href="tel:+381325377050">+381 32 53 77 050</a> </h6> </div></div><div id="cZZ4" class="col-lg-3"> <div class="divLeft"> <i style="" class="faZ fa fa-lock" aria-hidden="true"> </i> </div><div class="divright"> <h4> 100% sigurna kupovina </h4> <h6> Možete biti potpuno sigurni pri online plaćanju na našem sajtu. Brinemo i o sigurnosti Vaših ličnih podataka i poštovanju Vaše privatnosti. </h6> </div></div><div id="cZZ5" class="col-lg-3"style="height:8px;"> </div></div>';
...
el3.innerHTML = '<div id="search_block_top" class="col-sm-4 clearfix cc12"> <div class="shop-phoneZ is_logged" style="font-size:26px; font-weight:600; color:#606061;letter-spacing:0em;"><a style="letter-spacing:0em;" href="tel:+381325377050">+381 32 53 77 050</a> </div><div class="kazinka"> <div id="cz1" class="shop-phone2 is_logged" style="font-size:14px; font-weight:300; color:#606061;"> Radnim danima od 8:00 do 15:00 </div><div id="cz2" class="shop-phone2 is_logged" style="font-size:14px; font-weight:300; color:#606061"> Subotom od 9:00 do 14:00 </div></div></div>';
...
el4.innerHTML = '<div class="clearfix col-lg-12 sf-contener"><section class="header" id="header"><div id="sticky_wrapper"><div id="sticky_navigation"><nav id="top-navigation"><ul id="#main-nav"><li class="menu-item-a parent-cat" id="menu-a-1" style=" width: 118px;"><a id="duseciZen1" class="krkiNZ" href="https://www.sdream.rs/sr/duseci/" style="color: rgb(119, 119, 119);">Dušeci</a><div class="nav-dropdown-container"><div class="links-container"><ul class="nav-dropdown"><li><a id="duseciOdPeneZen2" href="https://www.sdream.rs/sr/duseci/duseci-od-pene/" style="margin-left: 34px;font-size: 11px;font-weight: 900;"><img src="https://www.sdream.rs/28-small_default/spa.jpg" alt="Dušeci od pene" title="Dušeci od pene" style=" width: 34px; position: absolute; left: -37px; top: -11px;">Dušeci od pene</a></li><li><a id="duseciSaDzepastimJezgromZen1" href="https://www.sdream.rs/sr/duseci/duseci-sa-dzepicastim-jezgrom/" style=" margin-left: 34px; font-size: 11px; font-weight: 900;"><img src="https://www.sdream.rs/98-small_default/green-plus-26cm.jpg" alt="Dušeci sa džepastim jezgrom" title="Dušeci sa džepastim jezgrom" style=" width: 34px; position: absolute; left: -37px; top: -11px;">Dušeci sa džepastim jezgrom</a></li><li><a id="duseciSaZicanimJezgromZen1" href="https://www.sdream.rs/sr/duseci/duseci-sa-zicanim-jezgrom/" style=" margin-left: 34px; font-size: 11px; font-weight: 900;"><img src="https://www.sdream.rs/93-small_default/fleks-24cm.jpg" alt="Dušeci sa žičanim jezgrom" style=" width: 34px; position: absolute; left: -37px; top: -11px;" title="Dušeci sa žičanim jezgrom">Dušeci sa žičanim jezgrom</a></li><li><a id="decijiDuseciZen1" href="https://www.sdream.rs/sr/duseci/deciji-duseci/" style=" margin-left: 34px; font-size: 11px; font-weight: 900;"><img src="https://www.sdream.rs/100-small_default/baby-energy.jpg" alt="Dečiji dušeci" style=" width: 34px; position: absolute; left: -37px; top: -11px;" title="Dečiji dušeci">Dečiji dušeci</a></li><li><a id="navlakeZen1" href="https://www.sdream.rs/sr/navlake/" style="margin-left: 34px; font-size: 11px; font-weight: 900; color: rgb(119, 119, 119);"><img src="https://www.sdream.rs/57-small_default/step-deka.jpg" alt="Navlaka za dušek Inesi" style=" width: 34px; position: absolute; left: -37px; top: -11px;" title="Navlake">Navlake</a></li></ul><div class="menu-divider" style=" margin-bottom: 29px;"></div><ul class="nav-dropdown"><li><a href="https://www.sdream.rs/sr/duseci-od-pene/apolon/" style=" margin-left: 34px; font-size: 11px; font-weight: 900;" class="replace-2x img-responsive"><img src="https://www.sdream.rs/94-small_default/apolon.jpg" alt="Apolon, 30cm" style=" width: 34px; position: absolute; left: -37px; top: -11px;" class="replace-2x img-responsive" title="Apolon, 30cm">Apolon, 30cm</a></li><li><a id="memoProstirkaZ" href="https://www.sdream.rs/sr/duseci/memo-prostirka/" style=" margin-left: 34px; font-size: 11px; font-weight: 900;"><img class="img-responsive" id="thumb_29" src="https://www.sdream.rs/147-small_default/memo-prostirka.jpg" alt="Memo prostirka, 2cm" title="Memo prostirka, 2cm" height="80" width="80" itemprop="image" style=" width: 34px; position: absolute; left: -37px; top: -11px;">Memo Prostirka, 2cm</a></li><li><a id="afroditaZ" href="https://www.sdream.rs/sr/duseci-sa-dzepicastim-jezgrom/afrodita/" style=" margin-left: 34px; font-size: 11px; font-weight: 900;"><img src="https://www.sdream.rs/97-small_default/afrodita.jpg" alt="Afrodita, 28cm" style=" width: 34px; position: absolute; left: -37px; top: -11px;" title="Afrodita, 28cm">Afrodita, 28cm</a></li><li><a id="greenPlusZen" href="https://www.sdream.rs/sr/duseci-sa-dzepicastim-jezgrom/green-plus-26cm/" style=" margin-left: 34px; font-size: 11px; font-weight: 900;"><img src="https://www.sdream.rs/98-small_default/green-plus-26cm.jpg" alt="Green Plus, 26cm" style=" width: 34px; position: absolute; left: -37px; top: -11px;" title="Green Plus, 26cm">Green Plus, 26cm</a></li></ul></div><div class="cat-img"><a href="https://www.sdream.rs/sr/duseci/"><span class="cat-img-text">Dušeci </span><img width="225" height="345" src="https://sdream.rs/themes/SDreamShopTheme/img/duseciSdream.jpg"></a></div></div></li><li class="menu-item-a parent-cat" id="menu-a-2"><a class="krkiNZ" id="jastuciZen1" href="https://www.sdream.rs/sr/jastuci/" style="color: rgb(119, 119, 119);">Jastuci</a><div class="nav-dropdown-container"><div class="links-container"><ul class="nav-dropdown"><li><a id="mhrZen" href="https://www.sdream.rs/sr/jastuci/kontur-mhr/" style="margin-left: 34px;font-size: 11px;font-weight: 900;"><img src="https://www.sdream.rs/45-small_default/kontur-mhr.jpg" alt="Kontur M/HR" style=" width: 34px; position: absolute; left: -37px; top: -11px;">KONTUR M/HR</a></li><li><a id="msZen" href="https://www.sdream.rs/sr/jastuci/kontur-ms/" style="margin-left: 34px;font-size: 11px;font-weight: 900;"><img src="https://www.sdream.rs/46-small_default/kontur-ms.jpg" alt="Kontur M/S" style=" width: 34px; position: absolute; left: -37px; top: -11px;">Kontur M/S</a></li><li><a id="memorisanZen" href="https://www.sdream.rs/sr/jastuci/memorisan/" style="margin-left: 34px;font-size: 11px;font-weight: 900;"><img src="https://www.sdream.rs/49-small_default/memorisan.jpg" alt="Memorisan" style=" width: 34px; position: absolute; left: -37px; top: -11px;">Memorisan</a></li><li><a id="sweetDreamZen" href="https://www.sdream.rs/sr/jastuci/sweet-dream/" style="margin-left: 34px;font-size: 11px;font-weight: 900;"><img src="https://www.sdream.rs/51-small_default/sweet-dream.jpg" alt="Sweet Dream" style=" width: 34px; position: absolute; left: -37px; top: -11px;">Sweet Dream</a></li></ul><div class="menu-divider"></div><ul class="nav-dropdown"><li><a id="memoCoolClassicZen" href="https://www.sdream.rs/sr/jastuci/memo-cool-classic/" style="margin-left: 34px;font-size: 11px;font-weight: 900;"><img src="https://www.sdream.rs/47-small_default/memo-cool-classic.jpg" alt="Memo Cool Classic" style=" width: 34px; position: absolute; left: -37px; top: -11px;">Memo Cool Classic</a></li><li><a id="memoCoolKonturZen" href="https://www.sdream.rs/sr/jastuci/memo-cool-kontur/" style="margin-left: 34px;font-size: 11px;font-weight: 900;"><img src="https://www.sdream.rs/48-small_default/memo-cool-kontur.jpg" alt="Memo Cool Kontur" style=" width: 34px; position: absolute; left: -37px; top: -11px;">Memo Cool Kontur</a></li></ul><div class="menu-divider"></div><ul class="nav-dropdown"><li><a id="sofyZen" href="https://www.sdream.rs/sr/jastuci/softy/" style="margin-left: 34px;font-size: 11px;font-weight: 900;"><img src="https://www.sdream.rs/50-small_default/softy.jpg" alt="Softy" style=" width: 34px; position: absolute; left: -37px; top: -11px;">Softy</a></li></ul></div><div class="cat-img"><a href="https://www.sdream.rs/sr/jastuci/"><span class="cat-img-text">Jastuci </span><img width="225" height="345" src="https://sdream.rs/themes/SDreamShopTheme/img/sdreamJastuci.jpg"></a></div></div></li><li class="menu-item-a parent-cat" id="menu-a-3"><a class="krkiNZ" id="nadduseciZen1" href="https://www.sdream.rs/sr/nadduseci/" style="color: rgb(119, 119, 119);">Naddušeci</a><div class="nav-dropdown-container"><div class="links-container"><ul class="nav-dropdown"><li><a id="memo44Zen" href="https://www.sdream.rs/sr/nadduseci/naddusek-memo-4-4cm/" style="margin-left: 34px;font-size: 11px;font-weight: 900;"> <img src="https://www.sdream.rs/53-small_default/naddusek-memo-4-4cm.jpg" alt="Naddušek Memo 4, 4cm" style=" width: 34px; position: absolute; left: -37px; top: -11px;"> Naddušek Memo 4, 4cm</a></li><li><a id="memoSoftZen" href="https://www.sdream.rs/sr/nadduseci/naddusek-memo-soft-5cm/" style="margin-left: 34px;font-size: 11px;font-weight: 900;"><img src="https://www.sdream.rs/55-small_default/naddusek-memo-soft-5cm.jpg" alt="Naddušek Memo soft, 5cm" style=" width: 34px; position: absolute; left: -37px; top: -11px;">Naddušek Memo soft, 5cm</a></li><li><a id="memoZen77" href="https://www.sdream.rs/sr/nadduseci/naddusek-memo-7-7cm/" style="margin-left: 34px;font-size: 11px;font-weight: 900;"><img src="https://www.sdream.rs/54-small_default/naddusek-memo-7-7cm.jpg" alt="Naddušek Memo 6, 6cm" style=" width: 34px; position: absolute; left: -37px; top: -11px;">Naddušek Memo 6, 6cm</a></li></ul><div class="menu-divider"></div><ul class="nav-dropdown"><li><a id="hr44cmZen" href="https://www.sdream.rs/sr/nadduseci/naddusek-hr-4-4cm/" style="margin-left: 34px;font-size: 11px;font-weight: 900;"><img src="https://www.sdream.rs/52-small_default/naddusek-hr-4-4cm.jpg" alt="Naddušek HR 4, 4cm" style=" width: 34px; position: absolute; left: -37px; top: -11px;"> Naddušek HR 4, 4cm</a></li><li><a id="softZenZen" href="https://www.sdream.rs/sr/nadduseci/naddusek-soft-4-4cm/" style="margin-left: 34px;font-size: 11px;font-weight: 900;"><img src="https://www.sdream.rs/56-small_default/naddusek-soft-4-4cm.jpg" alt="Naddušek Soft 4, 4cm" style=" width: 34px; position: absolute; left: -37px; top: -11px;">Naddušek Soft 4, 4cm</a></li></ul><div class="menu-divider"></div><ul class="nav-dropdown"><li><a id="stepDekaZen" href="https://www.sdream.rs/sr/nadduseci/step-deka/" style="margin-left: 34px;font-size: 11px;font-weight: 900;"><img src="https://www.sdream.rs/57-small_default/step-deka.jpg" alt="Štep deka" style=" width: 34px; position: absolute; left: -37px; top: -11px;">Štep deka</a></li></ul></div><div class="cat-img"><a href="https://www.sdream.rs/sr/nadduseci/"><span class="cat-img-text">Naddušeci </span><img width="225" height="345" src="https://sdream.rs/themes/SDreamShopTheme/img/nadduseciSdream.jpg"></a></div></div></li><li class="menu-item-a parent-cat" id="menu-a-3-a"><a class="krkiNZ" id="krevetiZen1" href="https://www.sdream.rs/sr/kreveti/" style="color: rgb(119, 119, 119);">Kreveti</a><div class="nav-dropdown-container"><div class="links-container"><ul class="nav-dropdown"><li id="kkeess"><a id="dodaciZaKreveteZen" href="https://www.sdream.rs/sr/kreveti/dodaci-za-krevete/" style="margin-left: 34px;font-size: 11px;font-weight: 900;"><img src="https://www.sdream.rs/112-small_default/k1.jpg" alt="K1" style="width: 34px;position: absolute;left: -37px;top: -7px;">Dodaci za krevete</a></li><li><a id="k1sofazen" href="https://www.sdream.rs/sr/kreveti/k-1-sofa/" style="margin-left: 34px;font-size: 11px;font-weight: 900;"><img src="https://www.sdream.rs/116-small_default/k1-sofa.jpg" alt="K1 - sofa" style="width: 34px;position: absolute;left: -37px;top: -7px;">Krevet K1 - sofa</a></li><li><a id="k2zen" href="https://www.sdream.rs/sr/kreveti/k-2/" style="margin-left: 34px;font-size: 11px;font-weight: 900;"><img src="https://www.sdream.rs/118-small_default/k2.jpg" alt="K2" style="width: 34px;position: absolute;left: -37px;top: -7px;">Krevet K - 2</a></li></ul><div class="menu-divider"></div><ul class="nav-dropdown"><li><a id="k4zen" href="https://www.sdream.rs/sr/kreveti/k-4/" style="margin-left: 34px;font-size: 11px;font-weight: 900;"><img src="https://www.sdream.rs/123-small_default/k-4.jpg" alt="K-4" style="width: 34px;position: absolute;left: -37px;top: -7px;" "="">Krevet K - 4</a></li><li><a id="k6zen" href="https://www.sdream.rs/sr/kreveti/k-6/" style="margin-left: 34px;font-size: 11px;font-weight: 900;"><img src="https://www.sdream.rs/125-small_default/k-6.jpg" alt="K-6" style="width: 34px;position: absolute;left: -37px;top: -7px;">Krevet K - 6</a></li><li><a id="k7zen" href="https://www.sdream.rs/sr/kreveti/k-7/" style="margin-left: 34px;font-size: 11px;font-weight: 900;"><img src="https://www.sdream.rs/148-small_default/k-7.jpg" alt="K-7" style="width: 34px;position: absolute;left: -37px;top: -7px;">Krevet K - 7</a></li></ul><div class="menu-divider"></div><ul class="nav-dropdown"><li><a id="k10zen" href="https://www.sdream.rs/sr/kreveti/k-10/" style="margin-left: 34px;font-size: 11px;font-weight: 900;"><img src="https://www.sdream.rs/130-small_default/k-10.jpg" alt="K-10" style="width: 34px;position: absolute;left: -37px;top: -7px;">Krevet na sprat K - 10</a></li><li><a id="k14zen" href="https://www.sdream.rs/sr/kreveti/k-14/" style="margin-left: 34px;font-size: 11px;font-weight: 900;"><img src="https://www.sdream.rs/134-small_default/k-14.jpg" alt="K-14" style="width: 34px;position: absolute;left: -37px;top: -7px;">Krevet na sprat K - 14</a></li></ul></div><div class="cat-img"><a href="https://www.sdream.rs/sr/kreveti/"><span class="cat-img-text">Kreveti</span><img width="225" height="345" src="https://sdream.rs/themes/SDreamShopTheme/img/krevetiSdream.jpg"></a></div></div></li><li class="menu-item-a parent-cat" id="menu-a-3-b" style="width: 120px;"><a class="krkiNZ" id="nadduseciZen1" href="https://www.sdream.rs/sr/tekstilni-proizvodi/" style="color: rgb(119, 119, 119);">Tekstilni proizvodi</a><div class="nav-dropdown-container"><div class="links-container" style=" padding: 0;"><ul class="nav-dropdown iolep"><li class=""><a id="PosteljineZen1" href="https://www.sdream.rs/sr/tekstilni-proizvodi/posteljine/" style="padding-bottom: 4px;">Posteljine</a></li></ul><div class="menu-divider" style="margin: 0px 20px 0px;"></div><ul class="nav-dropdown iolep"><li class=""><a id="jorganiZen1" href="https://www.sdream.rs/sr/tekstilni-proizvodi/jorgani/" style=" padding-bottom: 4px;">Jorgani</a></li></ul><div class="menu-divider" style="margin: 0px 20px 0px;"></div><ul class="nav-dropdown iolep"><li class=""><a id="cebadZen1" href="https://www.sdream.rs/sr/tekstilni-proizvodi/%C4%87ebad/" style=" padding-bottom: 4px;">Ćebad</a></li></ul><div class="menu-divider" style="margin: 0px 20px 0px;"></div><ul class="nav-dropdown iolep"><li class=""><a id="prekrivaciZen1" href="https://www.sdream.rs/sr/tekstilni-proizvodi/prekriva%C4%8Di/" style=" padding-bottom: 4px;">Prekrivači</a></li></ul><div class="menu-divider" style="margin: 0px 20px 0px;"></div><ul class="nav-dropdown iolep"><li class=""><a id="krevetskiCarsaviZen1" href="https://www.sdream.rs/sr/tekstilni-proizvodi/krevetski-%C4%8Dar%C5%A1avi/" style=" padding-bottom: 4px;">Krevetski čaršavi</a></li></ul><div class="menu-divider" style="margin: 0px 20px 0px;"></div><ul class="nav-dropdown iolep"><li class=""><a id="krevetskiCarsaviZen1" href="https://sdream.rs/sr/tekstilni-proizvodi/step-deke/" style=" padding-bottom: 4px;">Štep deke</a></li></ul><div class="menu-divider" style="margin: 0px 20px 0px;"></div><ul class="nav-dropdown iolep"><li class=""><a id="krevetskiCarsaviZen1" href="https://sdream.rs/sr/tekstilni-proizvodi/kuhinja/" style=" padding-bottom: 4px;">Kuhinja</a></li></ul><div class="menu-divider" style="margin: 0px 20px 0px;"></div><ul class="nav-dropdown iolep"><li class=""><a id="krevetskiCarsaviZen1" href="https://sdream.rs/sr/tekstilni-proizvodi/kupatilo/" style=" padding-bottom: 4px;">Kupatilo</a></li></ul><div class="menu-divider" style="margin: 0px 20px 0px;"></div></div><div class="cat-img"><a href="https://www.sdream.rs/sr/tekstilni-proizvodi/"><span class="cat-img-text">Tekstilni proizvodi</span><img width="225" height="345" src="https://sdream.rs/themes/SDreamShopTheme/img/tekstilniProizvodiSdream.jpg"></a></div></div></li><li class="menu-item-a parent-cat" id="menu-a-5"><a id="akcijeZen" href="https://www.sdream.rs/sr/akcije">Akcije</a></li><li class="menu-item-a parent-cat" id="menu-a-6"><span id="maloZ2" onclick="pageChecl()" style="cursor:pointer;">Maloprodaje</span></li><li class="menu-item-a parent-cat" id="menu-a-7"><a id="kontaktZen1" href="https://www.sdream.rs/sr/kontakt" class="">Kontakt</a></li></ul></nav></div></div></section></div>';
var div4 = document.getElementById("block_top_menu");
insertAfter(div4, el4);

$( ".iolep" ).hover(function() {
    $( ".iolep" ).each(function() {
       $( this ).find('ul.kemerez').removeClass( "keremenka" );
    });
 
    $( this ).find('ul.kemerez').addClass( "keremenka" );
    $( this ).find('li').first().addClass( "keremenka" );
  }, function() {
    $( this ).find('li').first().removeClass( "keremenka" );
    $( this ).find('ul.kemerez').removeClass( "keremenka" );
  });
...
document.getElementById('mySidenav').innerHTML = '<a href="javascript:void(0)" class="closebtn" onclick="closeNav()">×</a> <div class="zmijskiZMenu" id="zmijskiZMenu"> <i id="iO5" style="float: right; color: rgb(240, 100, 35); display: block; transition-delay: 0.1s;" onclick="openZ1menu()" class="fa fa-sort-desc" aria-hidden="true"></i> <a id="duseciZen2" href="https://www.sdream.rs/sr/duseci/">Dušeci</a><ul class="nav-dropdown"><li><a class="zmijskiZ" id="duseciOdPeneZen1" href="https://www.sdream.rs/sr/duseci/duseci-od-pene/">Dušeci od pene</a></li><li><a id="duseciSaDzepastimJezgromZen2" class="zmijskiZ" href="https://www.sdream.rs/sr/duseci/duseci-sa-dzepicastim-jezgrom/">Dušeci sa džepastim jezgrom</a></li><li><a id="duseciSaZicanimJezgromZen2" class="zmijskiZ" href="https://www.sdream.rs/sr/duseci/duseci-sa-zicanim-jezgrom/">Dušeci sa žičanim jezgrom</a></li><li><a id="decijiDuseciZen2" class="zmijskiZ" href="https://www.sdream.rs/sr/duseci/deciji-duseci/">Dečiji dušeci</a></li></ul> </div><a class="zmijskiZ2" id="jastuciZen2" href="https://www.sdream.rs/sr/jastuci/">Jastuci</a> <a class="zmijskiZ2" id="nadduseciZen2" href="https://www.sdream.rs/sr/nadduseci/">Naddušeci</a> <a class="zmijskiZ2" id="navlakeZen2" href="https://www.sdream.rs/sr/navlake/">Navlake</a><a class="zmijskiZ2" id="krevetiZen2" href="https://sdream.rs/sr/kreveti/">Kreveti</a><a class="zmijskiZ2" id="tekstilniProizvodiZen2" href="https://sdream.rs/sr/tekstilni-proizvodi/">Tekstilni proizvodi</a> <a class="zmijskiZ2" href="#">Akcije</a> <span class="zmijskiZ2" id="maloZ3" onclick="pageChecl()">Maloprodaje</span> <a class="zmijskiZ2" id="kontaktZen2" href="https://www.sdream.rs/sr/kontakt">Kontakt</a> <span id="kakoKupitiZen3" class="zmijskiZ2" onclick="pageCheclkakoKupiti()">Kako Kupiti</span><span id="kakoOdabratiZen3" class="zmijskiZ2" onclick="pageCheclkakoOdabrati()">Kako odabrati dušek</span> <a href="https://www.sdream.rs/sr/info/nacin-placanja/" class="zmijskiZ2">Način plaćanja</a> <span id="faqZen3" onclick="pageCheckFAQ()" span="" class="zmijskiZ2">Najčešća pitanja</span>';
}
function animatiza(){
...
var xzy = window.location.href; 
			if (xzy.indexOf("/maloprodaje/") >= 0) {} 
			else {
					if (history.pushState) {
						var historyTitle = document.title;
						var historyz = document.getElementById('columns').innerHTML;
						var urlZen = window.location.href;
							if(urlZen.indexOf('/sr/')>= 0){var newurl = window.location.protocol + "//" + window.location.host + '/sr/' + 'maloprodaje/';}
							else {newurl = window.location.protocol + "//" + window.location.host + window.location.pathname + 'maloprodaje/';}
						...
						activeZen();
							...
							document.title = 'Maloprodaje - S Dream Shop';	
...
function oNama() {
		var xzy = window.location.href; 
			if (xzy.indexOf("/o-nama/") >= 0) {} 
					...
					if (history.pushState) {
						...
						var historyz = document.getElementById('columns').innerHTML;
						var urlZen = window.location.href;
							if(urlZen.indexOf('/sr/')>= 0){var newurl = window.location.protocol + "//" + window.location.host + '/sr/' + 'o-nama/';}
							else {newurl = window.location.protocol + "//" + window.location.host + window.location.pathname + 'o-nama/';}
							document.getElementById('columns').innerHTML = '<style>.prva{margin-top:16px;}.prva::before{content: " "; background:url(https://www.sdream.rs/upload/1.png); width: 30px; height: 15px; display: inline-block; background-repeat: no-repeat;}.druga::before{content: " "; background:url(https://www.sdream.rs/upload/2.png); width: 30px; height: 15px; display: inline-block; background-repeat: no-repeat;}.treca::before{content: " "; background:url(https://www.sdream.rs/upload/3.png); width: 30px; height: 15px; display: inline-block; background-repeat: no-repeat;}.productListingZ{list-style:none;}.video-container{margin-left:15px; margin-right:15px; position:relative; padding-bottom:56.25%; padding-top:30px; height:0; overflow:hidden;}.video-container iframe, .video-container object, .video-container embed{position:absolute; top:0; left:0; width:100%; height:100%;}.leftZZ{margin-bottom:12px; font-family: myFirstFont2!important; font-size:15px; text-align:justify;}.zukiraZo{margin-bottom:32px; font-weight:bold;border-bottom:2px solid #606060; margin-left:30px; margin-right:30px;color:#f06423;}</style><div class="row" style="margin-bottom:24px;"> <div class="row"> <div class="col-md-12"> <h1 class="zukiraZo">O nama </h1> </div></div><div class="col-md-6"> <div class="col-md-12 leftZZ">Kompanija Vapeks iz Čačka, članica FoamLine grupe iz Rusije, je duži niz godina lider u regionu što se tiče proizvodnje svih vrsta pena (Sky cell pena, Memory pena, HR pena), a od 2010.godine počeli smo i proizvodnju dušeka. Naša kompanija je posvećena kreiranju i proizvodnji dušeka prema aktuelnim trendovima iz sveta, od materijala koje koriste najpoznatiji svetski proizvođači. Proizvodimo vrhunske proizvode ali po ceni koja je prilagođena mogućnostima tržišta i krajnjih kupaca. Možemo se pohvaliti širokim asortimanom i izuzetnim kvalitetom naših proizvoda. </div><div class="col-md-12 leftZZ">Našu kompaniju čini tim stručnjaka iz oblasti tehnologije proizvodnje, organizacije i logistike, marketinga i prodaje... Sarađujemo sa lekarima i fizioterapeutima najpoznatijih zdravstvenih institucija u Srbiji i Rusiji. Kontinuirano testiramo i proučavamo uticaj naših proizvoda na smanjenje tegoba sa kičmom, glavoboljama i hroničnim umorom. Na taj način unapređujemo naše proizvode, a našim kupcima dodatno poboljšavamo kvalitet života. </div><div class="col-md-12 leftZZ">Oformili smo laboratoriju sa istraživačkim centrom koji neprestano kontroliše kvalitet materijala i krajnih proizvoda i kreira nove proizvode sa poboljšanim karakteristikama. Osnova svih naših proizvoda je ispuna od najkvalitenijih SKY CELL sunđera. Zahvaljujući jedinstvenom tehnološkom rešenju kompanije BAYER, naši SKY CELL sunđeri imaju otvorene ćelije kroz koje neprestano struji svež vazduh. U našim proizvodima nema plesni niti grinja i nakon višegodišnje upotrebe, pa je zdrav san zagarantovan tokom čitavog perioda korišćenja. </div><div class="col-md-12 leftZZ">U skladu sa opredeljenima najpoznatijih proizvođača na svetu, proizvodimo vrhunske proizvode sa ispunom od različitih vrsta SKY CELL pena ili kombinacije pena sa visokokvalitetnim Bonnell oprugama ili džepičastim jezgrima.Brend dušeka S)DREAM je već prepoznatljiv na tržištu Srbije i u okruženju, i što je još važnije, ima idealan odnos cene i kvaliteta. </div><div class="col-md-12 leftZZ">Dobrom imidžu naših proizvoda doprinosi: <ul class="productListingZ" style="font-family: myFirstFont2!important;"> <li class="prva">jedini u zemlji imamo dušeke, naddušeke i jastuke sa MEMO COOL penom. Koristeći ovakav dušek uverićete se da svaki deo Vašeg tela u toku sna ima adekvatnu potporu i podršku. </li><li class="druga">kupcima nudimo sve vrste penastih/poliuretanskih dušeka sa profilisanim jezgrima i višezonskim dejstvom. </li><li class="treca">dobra pokrivenost tržišta - brend S)DREAM možete naći u svim većim salonima nameštaja i "sleep" shopovima na teritoriji čitave ex-YU, a prisutni smo i na najprobirljivijim evropskim tržištima, kao što su Nemačka, Grčka, Italija, Švajcarska, Rusija, Bugarska... </li></ul> </div><div class="col-md-12 leftZZ">U zavisnosti od specifičnosti tržišta i mogućnosti naših partnera zajedno sa njima kreiramo prilagođen asortiman sa našim S)DREAM brendom ili po želji naših partnera formiramo Private label liniju. Za nas saradnja ne prestaje prvom porudžbinom. Ona tek počinje tog trenutka i ne prestaje čak ni kada obezbedimo najbolju prodaju i prepoznatljiv imidž na tržištu. </div></div><div class="col-md-6"> <div class="col-md-12"> <img src="https://www.sdream.rs/upload/about-us-picture.jpg" style="width:100%; height:auto;"> </div></div></div><div class="row" id="iframeZkiZ" style="margin-bottom:24px;padding-bottom:32px;margin-lefT: 0px;margin-right: 0px;"> <div class="video-container"> <iframe style=" -moz-box-shadow: rgba(0, 0, 0, 0.17) 0px 5px 13px;-webkit-box-shadow: rgba(0, 0, 0, 0.17) 0px 5px 13px;box-shadow: rgba(0, 0, 0, 0.17) 0px 5px 13px;" src="https://www.youtube.com/embed/GaAdD6L4Agw" frameborder="0" allowfullscreen=""> </iframe> </div></div>';
							var stateObj = {path:newurl};
							window.history.pushState(stateObj,null,newurl);
						activeZen();
	...
	var xzy = window.location.href; 
			if (xzy.indexOf("/kako-odabrati-dusek/") >= 0) {} 
			else {
					if (history.pushState) {
						var historyTitle = document.title;
						var historyz = document.getElementById('columns').innerHTML;
						var urlZen = window.location.href;
							if(urlZen.indexOf('/sr/')>= 0){var newurl = window.location.protocol + "//" + window.location.host + '/sr/' + 'kako-odabrati-dusek/';}
							else {newurl = window.location.protocol + "//" + window.location.host + window.location.pathname + 'kako-odabrati-dusek/';}
							...
							document.title = 'Kako odabrati dušek - S Dream Shop';	
							$('html, body').animate({scrollTop: '0px'}, 300);	
							}
						window.onpopstate = function(event) {
							var xzy = window.location.href;
	...
	function kakoKupiti() {
		...
		var xzy = window.location.href; 
			if (xzy.indexOf("/kako-kupiti/") >= 0) {} 
			else {
					if (history.pushState) {
						var historyTitle = document.title;
						var historyz = document.getElementById('columns').innerHTML;
						var urlZen = window.location.href;
							if(urlZen.indexOf('/sr/')>= 0){var newurl = window.location.protocol + "//" + window.location.host + '/sr/' + 'kako-kupiti/';}
							else {newurl = window.location.protocol + "//" + window.location.host + window.location.pathname + 'kako-kupiti/';}
							...
							document.title = 'Kako kupiti - S Dream Shop';	
								$('html, body').animate({scrollTop: '0px'}, 300);								
							}
						window.onpopstate = function(event) {
							var xzy = window.location.href;
	...
	var xzy = window.location.href; 
			if (xzy.indexOf("/partneri/") >= 0) {} 
			else {
					if (history.pushState) {
						var historyTitle = document.title;
						var historyz = document.getElementById('columns').innerHTML;
						var urlZen = window.location.href;
							if(urlZen.indexOf('/sr/')>= 0){var newurl = window.location.protocol + "//" + window.location.host + '/sr/' + 'partneri/';}
							else {newurl = window.location.protocol + "//" + window.location.host + window.location.pathname + 'partneri/';}
							...
							document.title = 'Partneri - S Dream Shop';	
								$('html, body').animate({scrollTop: '0px'}, 300);								
...
var xzy = window.location.href; 
			if (xzy.indexOf("/modeli-saradnje/") >= 0) {} 
			else {
					if (history.pushState) {
						var historyTitle = document.title;
						var historyz = document.getElementById('columns').innerHTML;
						var urlZen = window.location.href;
							if(urlZen.indexOf('/sr/')>= 0){var newurl = window.location.protocol + "//" + window.location.host + '/sr/' + 'modeli-saradnje/';}
							else {newurl = window.location.protocol + "//" + window.location.host + window.location.pathname + 'modeli-saradnje/';}
							...
							document.title = 'Modeli saradnje - S Dream Shop';	
								$('html, body').animate({scrollTop: '0px'}, 300);			
							}
						window.onpopstate = function(event) {
							var xzy = window.location.href;
...
var xzy = window.location.href; 
			if (xzy.indexOf("/isporuka/") >= 0) {} 
			else {
					if (history.pushState) {
						var historyTitle = document.title;
						var historyz = document.getElementById('columns').innerHTML;
						var urlZen = window.location.href;
							if(urlZen.indexOf('/sr/')>= 0){var newurl = window.location.protocol + "//" + window.location.host + '/sr/' + 'isporuka/';}
							else {newurl = window.location.protocol + "//" + window.location.host + window.location.pathname + 'isporuka/';}
							...
							document.title = 'Isporuka - S Dream Shop';	
								$('html, body').animate({scrollTop: '0px'}, 300);			
							}
						window.onpopstate = function(event) {
							var xzy = window.location.href;
...
var xzy = window.location.href; 
			if (xzy.indexOf("/reklamacije/") >= 0) {} 
			else {
					if (history.pushState) {
						var historyTitle = document.title;
						var historyz = document.getElementById('columns').innerHTML;
						var urlZen = window.location.href;
							if(urlZen.indexOf('/sr/')>= 0){var newurl = window.location.protocol + "//" + window.location.host + '/sr/' + 'reklamacije/';}
							else {newurl = window.location.protocol + "//" + window.location.host + window.location.pathname + 'reklamacije/';}
								document.getElementById('columns').innerHTML = '<div id="columns" class="container"><div class="breadcrumb clearfix"> <a class="home" href="https://www.sdream.rs/" title="vratite se na Početak"><i class="icon-home"></i></a> <span class="navigation-pipe">&gt;</span> Reklamacije</div><div id="slider_row" class="row"></div><div class="row"><div id="center_column" class="center_column col-xs-12 col-sm-12"><h1 class="page-heading bottom-indent">Reklamacioni servis</h1><form action="/sr/kontakt" method="post" class="kiriZuljaZ contact-form-box" enctype="multipart/form-data"><fieldset><div class="clearfix"><div class="col-xs-12 col-md-12"> <input type="hidden" name="id_contact" value="1"><p id="desc_contact0" style="display:none;" class="desc_contact">&nbsp;</p><p id="desc_contact2" class="desc_contact contact-title unvisible"> <i class="icon-comment-alt"></i>For any question about a product, an order</p><p id="desc_contact1" class="desc_contact contact-title unvisible"> <i class="icon-comment-alt"></i>If a technical problem occurs on this website</p><p class="text"> <label for="extrafield2" id="fullnamez"> Ime i prezime </label> <input type="text" id="extrafield2" class="form-control grey validate" name="extrafield2" value=""></p><p class="text" style="display:none"> <label for="extrafield3" id="tipForme"> Tip forme </label> <input type="text" id="extrafield3" class="form-control grey validate" name="extrafield3" value="reklamacija"></p><p class="form-group"> <label for="email">E-mail adresa</label> <input class="form-control grey validate" type="text" id="email" name="from" data-validate="isEmail" value=""></p><p class="text"> <label for="extrafield4" id="brojTelefona"> Broj telefona </label> <input type="text" id="extrafield4" class="form-control grey validate" name="extrafield4" value=""></p><p class="text"> <label for="extrafield5" id="brojVasePordzbine"> Broj vaše pordžbinice </label> <input type="text" id="extrafield5" class="form-control grey validate" name="extrafield5" value=""></p><p class="text" style="display:none;"> <label for="extrafield" id="subject">Naslov poruke</label> <input class="form-control grey validate" type="text" id="extrafield" name="extrafield" value=""></p></div><div class="col-xs-12 col-md-12"><div class="form-group" style=""> <label for="message">Poruka</label><textarea class="form-control" style="height:200px;    background: #fbfbfb;" id="message" name="message"></textarea></div></div></div><div class="submit"> <button type="submit" name="submitMessage" id="submitMessage" class="button btn btn-default button-medium"><span>Pošalji<i class="icon-chevron-right right"></i></span></button></div></fieldset></form><div class="grizuljZ"><h1 class="page-heading bottom-indent"> Za sva pitanja vezana za reklamacije možete nas pozvati na broj:<br> <a style="color:#f06423;" href="tel:+381325377050">+381 32 53 77 050</a> ili popunite reklamacionu formu sa ove stranice. </h1><h1 class="page-heading bottom-indent"> Nakon uspešnog popunjavanja reklamacione forme bićete kontaktirani u najkraćem roku. </h1><p><strong>Pravo potro&scaron;ača na odustanak od ugovora na daljinu </strong></p><p>1. Potro&scaron;ač ima pravo da odustane od ugovora zaključenog na daljinu, odnosno izvan poslovnih prostorija u roku od 14 dana, bez navođenja razloga i dodatnih tro&scaron;kova, osim tro&scaron;kova iz čl. 34. i 35. ovog zakona (u daljem tekstu: odustanak od ugovora).</p><p>Potro&scaron;ač ostvaruje pravo na odustanak od ugovora izjavom koju može dati na posebnom obrascu za odustanak od ugovora zaključenog na daljinu, odnosno izvan poslovnih prostorija ili na drugi nedvosmislen način (u daljem tekstu: obrazac za odustanak).</p><p>Izjava o odustanku od ugovora kod ugovora na daljinu i ugovora koji se zaključuju izvan poslovnih prostorija smatra se blagovremenom ukoliko je poslata trgovcu u roku iz stava 1. ovog člana.</p><p>Izjava o odustanku od ugovora proizvodi pravno dejstvo od dana kada je poslata trgovcu.</p><p>Ako trgovac omogući potro&scaron;aču da elektronski popuni i po&scaron;alje obrazac za odustanak, dužan je da ga o prijemu obrasca bez odlaganja obavesti u pisanoj formi ili na drugom trajnom nosaču zapisa.</p><p>Protekom roka iz člana 29. ovog zakona prestaje pravo potro&scaron;ača na odustanak od ugovora.</p><p>Teret dokazivanja da je postupio u skladu sa odredbama st. 1.-5. ovog člana, radi ostvarivanja prava na odustanak od ugovora, je na potro&scaron;aču.</p><p>Oblik i sadržinu obrasca za odustanak propisuje ministar nadležan za poslove za&scaron;tite potro&scaron;ača (u daljem tekstu: Ministar)..</p><p><strong>NAPOMENA: Ovo pravo od odustanka od ugovora ne odnosi se na kupovinu u prodavnicama s obzirom da to nije kupovina na daljinu i izvan poslovnih prostorija.</strong></p><p><strong>Odgovornost za nesaobraznost </strong></p><p>Prodavac je odgovoran za nesaobraznost robe ugovoru koja se pojavi u roku od dve godine od dana prelaska rizika na potro&scaron;ača, odnosno dana kupovine proizvoda.</p><p><strong>2.Prodavac odgovara za nesaobraznosti isporučene robe ugovoru ako:</strong></p><p><strong>1) je postojala u času prelaska rizika na potro&scaron;ača, bez obzira na to da li je za tu nesaobraznost prodavac znao;</strong></p><p><strong>2) se pojavila posle prelaska rizika na potro&scaron;ača, ako potiče od uzroka koji je postojao pre prelaska rizika na potro&scaron;ača;</strong></p><p><strong>3) je potro&scaron;ač mogao lako uočiti, ukoliko je prodavac izjavio da je roba saobrazna ugovoru.</strong></p><p>Prodavac ne odgovara za nesaobraznost ako je u trenutku zaključenja ugovora potro&scaron;aču bilo poznato ili mu nije moglo ostati nepoznato da roba nije saobrazna ugovoru ili ako je uzrok nesaobraznosti u materijalu koji je dao potro&scaron;ač. Ako isporučena roba nije saobrazna ugovoru, potro&scaron;ač koji je obavestio prodavca o nesaobraznosti, ima pravo da zahteva od prodavca da otkloni nesaobraznost, bez naknade, opravkom ili zamenom, odnosno da zahteva odgovarajuće umanjenje cene ili da raskine ugovor u pogledu te robe. Potro&scaron;ač ima pravo da bira da nesaobraznost robe trgovac otkloni opravkom ili zamenom.</p><p>Ako otklanjanje nesaobraznosti opravkom ili zamenom nije moguće, potro&scaron;ač ima pravo da zahteva odgovarajuće umanjenje cene ili raskid ugovora ako:</p><p>1) nesaobraznost ne može da se otkloni opravkom ili zamenom uop&scaron;te niti u primerenom roku;</p><p>2) ne može da ostvari pravo na opravku ili zamenu, odnosno ako prodavac nije izvr&scaron;io opravku ili zamenu u primerenom roku;</p><p>3) opravka ili zamena ne može da se sprovede bez značajnijih nepogodnosti za potro&scaron;ača zbog prirode robe i njene namene;</p><p>4) otklanjanje nesaobraznosti opravkom ili zamenom predstavlja nesrazmerno opterećenje za prodavca.</p><p>Potro&scaron;ač ima pravo da zahteva zamenu, odgovarajuće umanjenje cene ili da raskine ugovor zbog istog ili drugog nedostatka saobraznosti koji se posle prve opravke pojavi, a ponovna opravka je moguća samo uz izričitu saglasnost potro&scaron;ača.</p><p>Uzimajući u obzir prirodu robe i svrhu zbog koje je potro&scaron;ač nabavio, opravka ili zamena mora se izvr&scaron;iti u primerenom roku bez značajnih neugodnosti za potro&scaron;ača i uz njegovu saglasnost.</p><p>Ako se nesaobraznost pojavi u roku od &scaron;est meseci od dana prelaska rizika na potro&scaron;ača, potro&scaron;ač ima pravo da bira između zahteva da se nesaobraznost otkloni zamenom, odgovarajućim umanjenjem cene ili da izjavi da raskida ugovor.</p><p>Ako se nesaobraznost pojavi u roku od &scaron;est meseci od dana prelaska rizika na potro&scaron;ača, otklanjanje nesaobraznosti moguće je opravkom uz izričitu saglasnost potro&scaron;ača.</p><p>Sve tro&scaron;kove koji su neophodni da bi se roba saobrazila ugovoru, a naročito tro&scaron;kove rada, materijala, preuzimanja i isporuke, snosi prodavac.</p><p>Potro&scaron;ač ne može da raskine ugovor ako je nesaobraznost robe neznatna.</p><p>Potro&scaron;ač će snositi tro&scaron;kove otklanjanja nedostataka u roku saobraznosti, u slučajevima:</p><p>1) nepo&scaron;tovanja uputstva za upotrebu i održavanje robe;</p><p>2) popravke robe od strane neovla&scaron;ćenog lica;</p><p>3) nepažljivog i nepravilnog rukovanja robom;</p><p>4) mehaničkih o&scaron;tećenja nastalih usled udaraca robe.</p><p>Potro&scaron;ač može da izjavi reklamaciju prodavcu radi ostvarivanja svojih prava iz čl. 52. Zakona o za&scaron;titi potro&scaron;ača, koja se odnose na otklanjanje nesaobraznosti, kao i zbog pogre&scaron;no obračunate cene i drugih nedostataka uz obavezu dostavljanja računa na uvid ili drugog dokaza o kupovini (kopija računa, slip i sl.)</p><p>3. Potro&scaron;ač može da izjavi reklamaciju usmeno na prodajnom mestu gde je roba kupljena, odnosno drugom mestu koje je određeno za prijem reklamacija, telefonom, pisanim putem, elektronskim putem, odnosno na trajnom nosaču zapisa, uz dostavu računa na uvid ili drugog dokaza o kupovini (kopija računa, slip i sl.).</p><p>&nbsp;</p><p>Prodavac je dužan da potro&scaron;aču izda pisanu potvrdu ili elektronskim putem potvrdi prijem reklamacije, odnosno saop&scaron;ti broj pod kojim je zavedena njegova reklamacija u evidenciji primljenih reklamacija.</p><p>Prodavac je dužan da bez odlaganja, a najkasnije u roku od osam dana od dana prijema reklamacije, pisanim ili elektronskim putem odgovori potro&scaron;aču na izjavljenu reklamaciju. Odgovor prodavca na reklamaciju potro&scaron;ača mora da sadrži odluku da li prihvata reklamaciju, izja&scaron;njenje o zahtevu potro&scaron;ača i konkretan predlog i rok za re&scaron;avanje reklamacije. Rok ne može da bude duži od 15 dana, odnosno 30 dana za tehničku robu i name&scaron;taj, od dana podno&scaron;enja reklamacije.</p><p>Prodavac je dužan da postupi u skladu sa odlukom, predlogom i rokom za re&scaron;avanje reklamacije, ukoliko je dobio prethodnu saglasnost potro&scaron;ača.</p><p>Ukoliko prodavac iz objektivnih razloga nije u mogućnosti da udovolji zahtevu potro&scaron;ača u roku koji je dogovoren, dužan je da o produžavanju roka za re&scaron;avanje reklamacije obavesti potro&scaron;ača i navede rok u kome će je re&scaron;iti, kao i da dobije njegovu saglasnost, &scaron;to je u obavezi da evidentira u evidenciji primljenih reklamacija. Produžavanje roka za re&scaron;avanje reklamacija moguće je samo jednom.</p><p>Reklamaciji zbog nedostataka ne podleže roba koja se prodaje sa oznakom "roba sa nedostatkom".</p><p>4. Potro&scaron;ač nema pravo na odustanak od ugovora u slučajevima koji su definisani čl.37 Zakona o za&scaron;titi potro&scaron;ača ("Sl. glasnik RS", br. 62/2014, 6/2016 - dr. zakon i 44/2018 - dr. zakon).</p><p>5. Potro&scaron;ač nema pravo na reklamaciju ako se utvrdi:</p><p>1) Da je kupac/potro&scaron;ač proizvodom rukovao nepravilno i na neodgovarajući način (savijao, uvijao, zaprljao du&scaron;ek organskim supstancama: krv, hemijski agensi i sl.), i/ili suprotno nameni proizvoda I preporuci spomenutoj na deklarativnom listu;</p><p>2) Da su nedostatci na proizvodu prouzrukovani postupcima trećih lica (fizička o&scaron;tećenja), za nedostatke nastale zbog ne pridražavanja uputstava za održavanje proizvoda, defekata nastalih usled vremenskih nepogoda, vi&scaron;e sile i/ili drugih razloga na koje proizvodjač nije mogao da utiče;</p><p>3) Da kupac/potro&scaron;ač nije skladi&scaron;tio proizvod na propisan način, te je usled toga do&scaron;lo do promena u/na proizvodu;</p><p>4) Da kupac/potro&scaron;ač prilikom reklamacije nije priložio broj fakture/fiskalnog računa, broj otpremnice, opis deformiteta i/ili nedostatka, &scaron;ta je su&scaron;tina reklamacije, iznos reklamacije registarski broj kamiona i fotografiju;</p><p>5) Da je kupac/potro&scaron;ač skidajuću navlaku prao na temperaturi većoj od 40 stepeni;</p><p>6) Da ne postoji Garantni list i/ili su na Garantnom listu uočljivi tragovi ispravljanja, a da nisu overeni pečatom proizvodjača/prodavca;</p><p>7) Garancija ne pokriva normalne promene u smislu osećaja povećanja mekoće zato &scaron;to to ne utiče bitno na ergonomska svojstva materijala od kog je jezgro izrađeno;</p><p><span lang="sr-Latn-RS"><strong>Link zakona o za&scaron;titi potro&scaron;ača </strong></span><u><a href="http://mtt.gov.rs/download/1(2)/ZZP.pdf"><span lang="sr-Latn-RS"><strong>http://mtt.gov.rs/download/1(2)/ZZP.pdf</strong></span></a></u></p><p><a name="_GoBack"></a> <span lang="sr-Latn-RS"><strong>NAPOMENA: ODGOVORNO LICE ZA PRIJEM REKLAMACIJA: Ljiljana Đoković Tel: 063 649 132 ; Email: ljiljana.djokovic@foamline.com</strong></span></p><p>&nbsp;</p> </div></div></div></div>';;
						
							var stateObj = {path:newurl};
							window.history.pushState(stateObj,null,newurl);
							activeZen();
							document.getElementById('reklamacijeZen').className += ' activePageZen';	
							document.title = 'Reklamacije - S Dream Shop';	
								$('html, body').animate({scrollTop: '0px'}, 300);			
							}
						window.onpopstate = function(event) {
							var xzy = window.location.href;
			...
			if (xzy.indexOf("/najcesca-pitanja/") >= 0) {} 
					...
					if (history.pushState) {
						...
						var urlZen = window.location.href;
							...
							document.title = 'Najčešća pitanja - S Dream Shop';	
								$('html, body').animate({scrollTop: '0px'}, 300);			
							}
						window.onpopstate = function(event) {
							var xzy = window.location.href;
...
var xzy = window.location.href; 
			if (xzy.indexOf("/mladenci-special/") >= 0) {} 
			else {
					if (history.pushState) {
						var historyTitle = document.title;
						var historyz = document.getElementById('columns').innerHTML;
						var urlZen = window.location.href;
							if(urlZen.indexOf('/sr/')>= 0){var newurl = window.location.protocol + "//" + window.location.host + '/sr/' + 'mladenci-special/';}
							else {newurl = window.location.protocol + "//" + window.location.host + window.location.pathname + 'mladenci-special/';}
							...
							var stateObj = {path:newurl};
							window.history.pushState(stateObj,null,newurl);
							document.title = 'Mladenci special - S Dream Shop';	
								$('html, body').animate({scrollTop: '0px'}, 300);			
							}
						window.onpopstate = function(event) {
							var xzy = window.location.href;
...
var xzy = window.location.href; 
			if (xzy.indexOf("/sertifikati/") >= 0) {} 
			else {
					if (history.pushState) {
						var historyTitle = document.title;
						var historyz = document.getElementById('columns').innerHTML;
						var urlZen = window.location.href;
							if(urlZen.indexOf('/sr/')>= 0){var newurl = window.location.protocol + "//" + window.location.host + '/sr/' + 'sertifikati/';}
							else {newurl = window.location.protocol + "//" + window.location.host + window.location.pathname + 'sertifikati/';}
							...
							var stateObj = {path:newurl};
							window.history.pushState(stateObj,null,newurl);
							document.title = 'Sertifikati - S Dream Shop';
...
function open1(){ if($('#open1').height() < 50) {$('#open1').css('height','190px'); $('.toggle-footer').css('display','block');document.getElementById("iO1").style.transform = "rotate(180deg)";} else {$('#open1').css('height','36px');document.getElementById("iO1").style.transform = "rotate(360deg)";} }
function open2(){ if($('#open2').height() < 50) {$('#open2').css('height','195px');$('.toggle-footer').css('display','block');document.getElementById("iO2").style.transform = "rotate(180deg)";} else {$('#open2').css('height','36px');document.getElementById("iO2").style.transform = "rotate(360deg)";} }
...
$( ".nav-dropdown-container" ).hover(
 ...
 if (xzy.indexOf("/duseci-od-pene/") >= 0) {
  ...
  if (xzy.indexOf("/duseci-sa-dzepicastim-jezgrom/") >= 0) {
							$('.content_scene_cat').css('display','none');
   ...
   if (xzy.indexOf("/duseci-sa-zicanim-jezgrom/") >= 0) {
							$('.content_scene_cat').css('display','none');
    ...
    if (xzy.indexOf("/deciji-duseci/") >= 0) {
							$('.content_scene_cat').css('display','none');
