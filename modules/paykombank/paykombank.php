...
class PayKombank extends PaymentModule
{
	public function __construct()
	{
		$this->name = 'paykombank';
		...
		$this->displayName = $this->l('Kombank');
		$this->description = $this->l('Accept payment by Kombank');
