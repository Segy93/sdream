...
{if $version < 1.5}
    ...
    <form method="post" action="{$admin_ajax_url|escape:'htmlall':'UTF-8'}">
        ...
        <div class="form-group">
            <label for="pp_amount2refund">{l s='Amount to be refunded' mod='payplug'} ({$currency->name|escape:'htmlall':'UTF-8'}) :</label>
            ...
            <input type="checkbox" value="{$id_new_order_state|escape:'htmlall':'UTF-8'}" name="change_order_state" >
        </div>
        <input class="btn green-button button" type="submit" name="submitPPRefund" value="{l s='Refund' mod='payplug'}" >
