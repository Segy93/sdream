	...
	<table class="table table-bordered footab">
		<thead>
			<tr>
				...
				{if $order->payment|escape:'html':'UTF-8' eq 'Komercijalna Banka'}	<th class="last_item">identifikacioni broj plaćanja </th>{/if}
			</tr>
		</thead>
		<tbody>
			...
			<tr class="item">
				...
				{if $order->payment|escape:'html':'UTF-8' eq 'Komercijalna Banka'}
				
					<td>{assign var=foorz value=Address::identifikacioniBrojPlacanja($order->id|intval)}</td>
					{/if}
			</tr>
			{/foreach}
		</tbody>
