...
{else}
 ...
 {assign var=producter value=[]}
	{foreach $products as $product}

{append var=producter value=['kategorijaProizvoda'=>{$product.category},'idProizvoda'=>{$product.id_product},'idAtributaProizvoda'=>{$product.id_product_attribute},'atributProizvoda'=>{$product.attributes},'cenaProizvoda'=>{$product.price},'cartId'=>{$cart->id},'userId'=>{Context::getContext()->customer->id},'kolicina'=>{$product.quantity}]}
...
{/foreach}
 ...
 {Cart::brisacica($producter)}
 {Cart::kukurnica($producter)}
{literal}
<script>
